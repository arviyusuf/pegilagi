...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
   ...
   <!-- Morris chart -->
   <link rel="stylesheet" href="<?php echo base_url() ?>gedang/admin/bower_components/morris.js/morris.css">
   <!-- jvectormap -->
   <link rel="stylesheet" href="<?php echo base_url() ?>gedang/admin/bower_components/jvectormap/jquery-jvectormap.css">
   <!-- Date Picker -->
   ...
   <link rel="stylesheet" href="<?php echo base_url() ?>gedang/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo base_url() ?>gedang/admin/index2.html" class="logo">
    ...
    <li class="dropdown user user-menu">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-header">
          ...
          <p>
            A<?php echo $this->session->userdata("nama"); ?> - Web Developer
...
<div class="content-wrapper">
  ...
  <section class="col-md-12 connectedSortable">
      <center><?php echo anchor('crud/tambahr','Tambah Data'); ?></center>
      <div class="box">
...
<!-- /.control-sidebar -->
 ...
 <!-- jQuery UI 1.11.4 -->
 <script src="<?php echo base_url() ?>gedang/admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url() ?>gedang/admin/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo base_url() ?>gedang/admin/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url() ?>gedang/admin/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo base_url() ?>gedang/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url() ?>gedang/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url() ?>gedang/admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url() ?>gedang/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?php echo base_url() ?>gedang/admin/<?php echo base_url() ?>gedang/admin/dist/js/pages/dashboard.js"></script>
