      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=<?php echo base_url() ?>gedang/admin/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href=<?php echo base_url() ?>gedang/admin/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
