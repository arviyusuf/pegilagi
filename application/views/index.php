...
<!-- banner -->
	<div class="banner">
		<div class="container">
			<div class="logo">
				<a href="assets/index.html">Globe <span>Trotting</span></a>
			</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="stroke">
						<ul class="nav navbar-nav">
							...
							<li><a href="assets/events.html">News & Events</a></li>
							<li><a href="assets/short-codes.html">Short Codes</a></li>
							<li><a href="assets/services.html">Services</a></li>
							<li><a href="assets/mail.html">Mail Us</a></li>
						</ul>
					</nav>
				</div>
				<!-- /.navbar-collapse -->
			...
			<div class="banner-bottom1-grids">
				<div class="col-md-4 banner-bottom1-grid">
					<div class="banner-bottom1-grid1">
						<a href="assets/single.html"><img src="assets/images/1.jpg" alt=" " class="img-responsive" /></a>
						<div class="banner-bottom1-grid1-left">
							<a href="assets/single.html">omnis dolor repellendus</a>
						</div>
						<div class="banner-bottom1-grid1-right">
							<ul>
								<li><a href="assets/#"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> 50</a></li>
								<li><a href="assets/#"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 150</a></li>
							</ul>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<div class="col-md-4 banner-bottom1-grid">
					<div class="banner-bottom1-grid1">
						<a href="assets/single.html"><img src="assets/images/3.jpg" alt=" " class="img-responsive" /></a>
						<div class="banner-bottom1-grid1-left">
							<a href="assets/single.html">omnis dolor repellendus</a>
						</div>
						<div class="banner-bottom1-grid1-right">
				...
				<div class="col-md-4 banner-bottom1-grid">
					<div class="banner-bottom1-grid1">
						<a href="assets/single.html"><img src="assets/images/2.jpg" alt=" " class="img-responsive" /></a>
						<div class="banner-bottom1-grid1-left">
							<a href="assets/single.html">omnis dolor repellendus</a>
						</div>
						<div class="banner-bottom1-grid1-right">
			...
			<div class="latest-posts-grids">
				<div class="col-md-3 latest-posts-grid">
					<div class="latest-posts-grid1">
						...
						<div class="latest-posts-grid11">
							<h5><a href="assets/single.html">corrupti quos dolores</a></h5>
							...
							<div class="latest-posts-grid11-right">
								<a href="assets/#"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> 3 Comments</a>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
				...
				<div class="col-md-3 latest-posts-grid">
					<div class="latest-posts-grid1">
						...
						<div class="latest-posts-grid11">
							<h5><a href="assets/single.html">accusamus iusto odio</a></h5>
							<h4>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis 
								praesentium</h4>
							<div class="latest-posts-grid11-left">
				...
				<div class="col-md-3 latest-posts-grid">
					<div class="latest-posts-grid1">
						...
						<div class="latest-posts-grid11">
							<h5><a href="assets/single.html">blanditiis prae ducimus</a></h5>
							<h4>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis 
								praesentium</h4>
							<div class="latest-posts-grid11-left">
				...
				<div class="col-md-3 latest-posts-grid">
					<div class="latest-posts-grid1">
						...
						<div class="latest-posts-grid11">
							<h5><a href="assets/single.html">odio dignissimos iusto</a></h5>
							<h4>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis 
								praesentium</h4>
							<div class="latest-posts-grid11-left">
...
<!-- twitter-comment -->
	<div class="twitter-comment">
		<div class="container">
			...
			<p>MS <a href="assets/mailto:info@example.com">@sowjo</a> The <a href="assets/mailto:info@example.com">@monostr</a>
				Bundle - 1 week Only <a href="assets/#">http//iuh/27Haweth.</a> Don't Pay Its Your $60.00 duration 2016-2030.
				<span>26-01-2016 <a href="assets/mailto:info@example.com">@sowjo.</a></span></p>
		</div>
	</div>
<!-- //twitter-comment -->
<!-- contact-us -->
	...
	<div class="footer">
		<div class="container"> 
			...
			<div class="footer-bottom-right">
				<ul>
					<li><a href="assets/#" class="icon-button twitter"><i class="icon-twitter"></i><span></span></a></li>
					<li><a href="assets/#" class="icon-button google"><i class="icon-google"></i><span></span></a></li>
					<li><a href="assets/#" class="icon-button v"><i class="icon-v"></i><span></span></a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- scroll_top_btn -->
	    ...
	    <script type="text/javascript">
		 ...
		 <a href="assets/#" id="toTop" style="display: block;"><span id="toTopHover" style="opacity: 1;"></span></a>
<!--end scroll_top_btn -->
